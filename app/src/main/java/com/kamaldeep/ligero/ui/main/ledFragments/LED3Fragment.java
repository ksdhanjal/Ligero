...
public class LED3Fragment extends Fragment
{
    ...
    {
        View root = inflater.inflate(R.layout.fragment_led3, container, false);

        picker = root.findViewById(R.id.colorPicker3);
        SVBar svBar = root.findViewById(R.id.svbar3);
        picker.addSVBar(svBar);

        rgbInfo = root.findViewById(R.id.rgbTextView3);
        col = picker.getColor();
        ...
        changeColourButton = root.findViewById(R.id.changeColorButton3);
        changeColourButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                makeURL();
                SERVER.urlHit(_URL);
                Log.e(TAG,"LED3 URL: " + _URL);
                //urlHIT();
            }
        });

        ToggleButton toggleButton = root.findViewById(R.id.toggleButton3);
        ...
        toggleButton.setOnCheckedChangeListener(new CompoundButton.OnCheckedChangeListener() {
            ...
            public void onCheckedChanged(CompoundButton compoundButton, boolean b) {
                ...
                {
                    power = 1;
                    SERVER.urlHit("http://"+ SERVER.IP_ADDRESS+"/change_led3/1");
                    changeColourButton.setEnabled(true);
                }
                else
                {
                    power = 0;
                    SERVER.urlHit("http://"+ SERVER.IP_ADDRESS+"/change_led3/0");
    ...
    private void makeURL()
    {
        ...
        _URL = "http://"+ SERVER.IP_ADDRESS+"/change_led3/"+redCol+","+
